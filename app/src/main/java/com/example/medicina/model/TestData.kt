...
class TestData {
    companion object {
        ...
        val MedicineRepository = mutableStateListOf(
            Medicine(0, "Biogesic", 0, 1, 10f, "For headache and minor pains"),
            Medicine(1, "Advil", 1, 1, 12f, "Anti-inflammatory and pain relief"),
            Medicine(2, "Calpol", 0, 1, 11.5f, "For pain and fever in children"),
            Medicine(3, "Medicol Advance", 1, 1, 14.75f, "Pain reliever for adults"),
            Medicine(4, "Tempra Forte", 0, 1, 13.25f, "Paracetamol for adults"),
            Medicine(5, "Motrin", 1, 1, 15f, "NSAID pain reliever"),
            Medicine(6, "Feverall", 0, 1, 9f, "Fever reducer"),
            Medicine(7, "Nurofen", 1, 1, 13f, "Relieves pain and reduces fever"),
            Medicine(8, "Panadol", 0, 1, 10.75f, "Pain and fever relief"),
            Medicine(9, "Tylenol", 0, 1, 12.5f, "Used to treat mild to moderate pain and fever"),
            Medicine(10, "Dolan", 1, 1, 10.25f, "Ibuprofen-based fever reducer"),
            Medicine(11, "Paracetamol Med", 0, 1, 8.75f, "Fever and pain"),
            Medicine(12, "Amoxil", 2, 2, 18f, "For bacterial infections"),
            Medicine(13, "Zithromax", 3, 2, 20f, "Antibiotic for respiratory infections"),
            Medicine(14, "Ciprobay", 8, 2, 22f, "Broad-spectrum antibiotic"),
            Medicine(15, "Doxycin", 9, 2, 19.5f, "Used for acne and respiratory infections"),
            Medicine(16, "Moxillin", 2, 2, 16.5f, "For bacterial throat and ear infections"),
            Medicine(17, "Cifran", 8, 2, 21f, "Used for urinary and respiratory infections"),
            Medicine(18, "Ventolin", 4, 1, 25f, "Asthma reliever"),
            Medicine(19, "Allerkid", 5, 1, 14f, "Allergy medicine"),
            Medicine(20, "Salbutamol GPO", 4, 1, 23.5f, "Bronchodilator"),
            Medicine(21, "Virlix", 5, 1, 13.25f, "For allergy and respiratory symptoms"),
            Medicine(22, "Asmalin", 4, 1, 22f, "Respiratory bronchodilator"),
            Medicine(23, "Zyrtec", 5, 1, 15f, "Allergy relief"),
            Medicine(24, "Prozac", 6, 2, 35f, "Antidepressant"),
            Medicine(25, "Risperdal", 7, 2, 40f, "Antipsychotic medication"),
            Medicine(26, "Fluoxx", 6, 2, 33f, "Used to treat depression and anxiety"),
            Medicine(27, "Rivastigmine", 7, 2, 45f, "Used for schizophrenia"),
            Medicine(28, "Zoloft", 6, 2, 38f, "Antidepressant SSRI"),
            Medicine(29, "Quetiapine", 7, 2, 42f, "Bipolar disorder and schizophrenia")
        )
